...
export default function MobileBottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 h-[72px] bg-white/80 dark:bg-neutral-900/80 backdrop-blur-md border-t border-neutral-200 dark:border-neutral-800 z-50 px-4 pb-[safe-area-inset-bottom] transition-all duration-150 shadow-[0_-4px_16px_rgba(0,0,0,0.06)]">
